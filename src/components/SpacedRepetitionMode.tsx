...
function SpacedRepetitionMode({ deckId, onExit }: SpacedRepetitionModeProps) {
	...
	return (
		<div
			className="flex flex-col max-w-4xl mx-auto p-4"
								...
								<div className="grid grid-cols-2 gap-3">
									...
									>
										<span className="flex items-center justify-between">
											...
											<kbd className="ml-2 px-1.5 py-0.5 text-xs bg-red-600 bg-opacity-50 rounded border border-red-400">
												1
											</kbd>
										</span>
									</button>
									...
									>
										<span className="flex items-center justify-between">
											...
											<kbd className="ml-2 px-1.5 py-0.5 text-xs bg-orange-600 bg-opacity-50 rounded border border-orange-400">
												2
											</kbd>
										</span>
									</button>
									...
									>
										<span className="flex items-center justify-between">
											...
											<kbd className="ml-2 px-1.5 py-0.5 text-xs bg-green-600 bg-opacity-50 rounded border border-green-400">
												3
											</kbd>
										</span>
									</button>
									...
									>
										<span className="flex items-center justify-between">
											...
											<kbd className="ml-2 px-1.5 py-0.5 text-xs bg-blue-600 bg-opacity-50 rounded border border-blue-400">
												4
											</kbd>
										</span>
									</button>
