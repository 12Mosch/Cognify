...
function KeyboardShortcutsModal({ 
  ...
  const studyModeTitle = studyMode === 'basic' ? 'Basic Study' : 'Spaced Repetition';
        ...
        <div className="p-6">
          ...
          <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
            <p className="text-xs text-slate-500 dark:text-slate-400 text-center">
              Press <kbd className="px-1 py-0.5 text-xs bg-slate-200 dark:bg-slate-600 rounded">Esc</kbd> to close this help
            </p>
          </div>
        </div>
      </div>
