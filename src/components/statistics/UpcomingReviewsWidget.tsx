  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-lg border-2 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-lg dark:hover:shadow-slate-900/20 transition-all duration-300 group">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-2xl hover:scale-110 transition-transform duration-200" role="img" aria-label="Calendar">
          📅
        </span>
      </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <div className={`w-3 h-3 rounded-full ${getUrgencyColor(review.date)} hover:scale-110 transition-transform duration-200`}></div>
                  <span className="text-lg hover:scale-110 transition-transform duration-200" role="img" aria-label="Priority">
        ...
        <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
          <div className="grid grid-cols-2 gap-4 text-center">
            <div className="hover:bg-slate-100 dark:hover:bg-slate-700 p-2 rounded transition-colors duration-200 cursor-pointer">
              ...
              <div className="text-xs text-slate-600 dark:text-slate-400 hover:text-slate-500 dark:hover:text-slate-300 transition-colors">{t('statistics.widgets.upcomingReviews.totalCards')}</div>
            </div>
            <div className="hover:bg-slate-100 dark:hover:bg-slate-700 p-2 rounded transition-colors duration-200 cursor-pointer">
              ...
              <div className="text-xs text-slate-600 dark:text-slate-400 hover:text-slate-500 dark:hover:text-slate-300 transition-colors">{t('statistics.widgets.upcomingReviews.reviewDays')}</div>
            </div>
          </div>
        </div>
      )}
