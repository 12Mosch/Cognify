...
describe('categorizeError', () => {
  it('should categorize different error types correctly', () => {
    ...
    expect(categorizeError(new Error('Authentication failed'))).toBe('authentication_error');
    expect(categorizeError(new Error('Permission denied'))).toBe('permission_error');
    expect(categorizeError(new Error('Validation failed'))).toBe('validation_error');
    expect(categorizeError(new Error('Operation is slow'))).toBe('performance_error');
    expect(categorizeError(new Error('Convex query failed'))).toBe('integration_error');
