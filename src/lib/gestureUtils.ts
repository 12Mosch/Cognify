 ...
 */
export function triggerVisualFeedback(direction: 'left' | 'right' | 'up' | 'down'): void {
 ...
 */
export function useFlashcardGestures(config: FlashcardGestureConfig): GestureHandlers {
  const {
    onFlipCard,
    onNextCard,
    onRateEasy,
