...
const mockTranslations = {
  en: {
    translation: {
      ...
      'study.progress.aria': 'Study progress: {{current}} of {{total}} cards completed, {{percentage}}% done',
      'study.progress.completedAria': 'Study session completed! All {{total}} cards reviewed.',
      'study.progress.inProgressAria': 'Study session in progress: {{current}} of {{total}} cards completed',
